...
| Nordlys Webstudio – nettsidetjeneste | Utkast 476012757, klart – krever 199 kr betaling | Sendt til Småjobber Oslo/Akershus (venter godkjenning) | n/a |
...
- 2026-09-09: Markedsføring av **Nordlys Webstudio** startet med lenken
  ...
  (venter administratorgodkjenning). Et engelsk innlegg ble først sendt til
  **GREEKS IN OSLO**, men ble slettet igjen etter uttrykkelig beskjed fra
  Stavros. Oslo Expats, Norway Buy, Sale and Rent og Students' Market Oslo ble
  kontrollert, men ikke brukt fordi gruppeformålet eller publiseringsformatet
  ikke passer ordinær tjenestereklame.
